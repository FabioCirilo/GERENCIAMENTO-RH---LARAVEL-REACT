    ...
    return (
        <div className="py-4 px-8">
            <div className="flex justify-between items-center">
                <h1 className="text-gray-500 text-[28px] font-light py-4 dark:text-white">
                    Perfil
                </h1>
                {!Errors && !Loading && (
                    <div className="py-4">
                ...
                <div className="flex gap-4">
                    ...
                    <div className="shadow-2xl relative flex-1 ">
                        ...
                        <ul className="bg-white dark:bg-gray-700 dark:border-slate-700 w-full flex gap-2 border-b-2 border-slate-200 transition-all">
                            <li
                                className={`transition dark:text-slate-300 cursor-pointer py-4 px-8 text-gray-700 ${
                                    ActiveTab === Tabs[0]
                                        ? "border-b-4 border-violet-500 text-violet-500"
                                        : "hover:border-b-4 hover:border-violet-500"
                                }`}
                                onClick={() => {
                                    setActiveTab(Tabs[0]);
                                }}
