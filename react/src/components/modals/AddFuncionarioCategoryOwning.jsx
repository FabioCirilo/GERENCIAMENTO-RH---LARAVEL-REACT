...
{
    /*const AddFuncionarioCategoryOwning = ({ isOpen, onClose, onAdicionar }) => {
            ...
            <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
                <div className="flex min-h-full items-end justify-center p-4 text-center sm:items-center sm:p-0">
                    ...
                    <div className="relative transform overflow-hidden rounded-lg bg-white text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                        <div className="bg-white px-2pb-23t-5 sm:p-6 sm:pb-4">
                        ...
                        <div className="px-4 py-3 ">
                            {funcionarios?.map((funcionario, index) => (
                                <div className="flex justify-between bg-slate-400 rounded-md mt-1 items-center p-2">
                                    <div
                                    ...
                                    >
                                        <img
                                            ...
                                            alt=""
                                        />
                                        <span className="pl-2 text-md text-white dark:text-white">
                                            {funcionario.nome}
                                        </span>
                                    </div>
                                    <div>
...
export default AddFuncionarioCategoryOwning;
