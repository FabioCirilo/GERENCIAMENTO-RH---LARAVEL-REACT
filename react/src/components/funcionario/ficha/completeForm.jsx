            ...
            <form className="py-4 ">
                <div className="flex items-center gap-20 py-4 bg-slate-100 dark:bg-gray-800 dark:text-slate-400">
                    <div className="flex w-full flex-col gap-4">
                        ...
                        <input
                            type="file"
                            className="file:bg-violet-700 file:border-none file:text-white "
                            onChange={setProfileIMG}
                        />
                    </div>
                    {ImgError && (
                        <div>
                            <span className="text-slate-400">{ImgError}</span>
                        </div>
                    )}

                    {!ImgError && ProfileImg && (
                        <MoveRight className="w-[40px] text-slate-400" />
                    )}
                    {!ImgError && ProfileImg && (
                        <div className="flex w-full flex-col gap-4">
                            <img
                ...
                <div className="pt-4">
                    ...
                    <div className="flex items-center justify-between  py-2">
                        ...
                        >
                            ...
                            <option
                                selected
                                value={funcionario.departamento.id}
                            >
                    ...
                    <div className="flex items-center justify-between  py-2">
                        ...
                        <input
                            value={funcionario.data_entrada}
                            type="text"
                            placeholder="Cargo"
                            className="dark:bg-gray-700 dark:border-slate-500 w-full py-1 px-1 text-gray-800 outline-none  border-2 border-slate-400 rounded focus:border-violet-700"
                        />
